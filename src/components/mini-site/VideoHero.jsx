...
export default function VideoHero({ 
  ...
  return (
    <section style={{ 
      ...
      {/* 1. Camada de fundo (Full-Bleed, 100% da largura, SEM padding) */}
      <div style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', overflow: 'hidden' }}>
        ...
        <div style={{ 
          position: 'absolute', 
          inset: 0, 
          background: 'linear-gradient(180deg, rgba(3, 7, 18, 0.3) 0%, rgba(3, 7, 18, 0.85) 65%, rgba(3, 7, 18, 1) 100%)' 
        }} />
      </div>

      {/* 2. Camada de conteúdo (Texto, Badge, Selo — COM padding de 24px e max-width 430px) */}
      <div style={{ 
        position: 'relative', 
        zIndex: 10, 
        width: '100%', 
        ...
        <div style={{ margin: 'auto 0 24px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
