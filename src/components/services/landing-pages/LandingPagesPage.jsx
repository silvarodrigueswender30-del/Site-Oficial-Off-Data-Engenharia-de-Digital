...
import LandingPagesWorkSection from './LandingPagesWorkSection';
import LandingPagesMissionSection from './LandingPagesMissionSection';
import LandingPagesCtaBox from './LandingPagesCtaBox';

const title = 'Landing Pages High Ticket | Off-Data Digital';
const descriptionText = 'Landing pages premium para ofertas High Ticket, criadas com estratégia, design sofisticado, copy persuasiva e foco em conversão.';
const canonicalUrl = 'https://www.offdata.digital/landing-pages-high-ticket';
const imageUrl = 'https://www.offdata.digital/imagens/offdata-digital-og.jpg';
const imageAlt = 'Landing Pages High Ticket criadas pela Off-Data Digital';
const schemaData = {
    ...
    <div className="agency-page">
      ...
      <main>
        ...
        <section id="mission-section" className="agency-company-block">
          <LandingPagesWorkSection />
          <LandingPagesMissionSection />
