...
import SeoLocalWorkSection from './SeoLocalWorkSection';
import SeoLocalMissionSection from './SeoLocalMissionSection';
import SeoLocalCtaBox from './SeoLocalCtaBox';

const title = 'SEO Local em Uberlândia | Off-Data Digital';
const descriptionText = 'Estratégias de SEO local em Uberlândia para empresas aparecerem no Google, fortalecerem autoridade regional e atraírem clientes qualificados.';
const canonicalUrl = 'https://www.offdata.digital/seo-local-uberlandia';
const imageUrl = 'https://www.offdata.digital/imagens/offdata-digital-og.jpg';
const imageAlt = 'SEO local em Uberlândia pela Off-Data Digital';
const schemaData = {
