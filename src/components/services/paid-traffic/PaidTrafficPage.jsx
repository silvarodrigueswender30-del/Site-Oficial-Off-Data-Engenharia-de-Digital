...
import PaidTrafficHero from './PaidTrafficHero';
import PaidTrafficWorkSection from './PaidTrafficWorkSection';
import PaidTrafficMissionSection from './PaidTrafficMissionSection';
import PaidTrafficCtaBox from './PaidTrafficCtaBox';

const title = 'Gestão de Tráfego Pago em Uberlândia | Off-Data Digital';
const descriptionText = 'Gestão de tráfego pago em Uberlândia com campanhas no Google Ads e Meta Ads focadas em geração de leads, vendas e ROI.';
const canonicalUrl = 'https://www.offdata.digital/trafego-pago-uberlandia';
const imageUrl = 'https://www.offdata.digital/imagens/offdata-digital-og.jpg';
const imageAlt = 'Gestão de tráfego pago em Uberlândia pela Off-Data Digital';
const schemaData = {
    ...
    <div className="agency-page">
      ...
      <main>
        ...
        <section id="mission-section" className="agency-company-block">
          <PaidTrafficWorkSection />
          <PaidTrafficMissionSection />
