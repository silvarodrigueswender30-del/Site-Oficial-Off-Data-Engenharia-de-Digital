...
import ImmersiveSitesHero from './ImmersiveSitesHero';
import ImmersiveSitesWorkSection from './ImmersiveSitesWorkSection';
import ImmersiveSitesMissionSection from './ImmersiveSitesMissionSection';
import ImmersiveSitesCtaBox from './ImmersiveSitesCtaBox';

const title = 'Criação de Sites em Uberlândia | Off-Data Digital';
const descriptionText = 'Criação de sites profissionais em Uberlândia para empresas que precisam de presença digital premium, performance, SEO e conversão.';
const canonicalUrl = 'https://www.offdata.digital/criacao-de-sites-uberlandia';
const imageUrl = 'https://www.offdata.digital/imagens/offdata-digital-og.jpg';
const imageAlt = 'Criação de sites imersivos premium pela Off-Data Digital';
const schemaData = {
    ...
    <div className="agency-page">
      ...
      <main>
        ...
        <section id="mission-section" className="agency-company-block">
          <ImmersiveSitesWorkSection />
          <ImmersiveSitesMissionSection />
          <AgencyPixelTransition />
        </section>
        <ImmersiveSitesCtaBox />
      </main>
      <FooterSection />
    </div>
  );
