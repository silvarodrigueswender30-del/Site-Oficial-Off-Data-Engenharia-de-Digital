    ...
    <section className={styles.editorial}>
      ...
      <div className={styles.pillarsLayout}>
        <div className={styles.sideImage}>
          <img ref={imageRef} src="/imagens/imagem-estrategia/sites-imersivos-clinicas-medicas-img2.avif" alt="Ambiente clínico sofisticado representando confiança e experiência digital" loading="lazy" decoding="async" />
        </div>
