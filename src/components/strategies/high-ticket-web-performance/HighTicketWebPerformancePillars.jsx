    ...
    <section className={styles.editorial}>
      ...
      <div className={styles.pillarsLayout}>
        <div className={styles.sideImage}>
          <img ref={imageRef} src="/imagens/imagem-estrategia/performance-web-marcas-high-ticket-img2.avif" alt="Arquitetura digital corporativa representando performance, estabilidade e rastreabilidade" loading="lazy" decoding="async" />
        </div>
